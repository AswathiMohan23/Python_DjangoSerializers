...
class employeeList(APIView):
    ...
    def post(self,request):
        print(request.data)
        serializer = EmployeeSerializer(request.data)  # take all objects and converts to json, many =true means there are many of them so here no need to return just one json object
